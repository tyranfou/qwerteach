...
# student
u = User.create(:email => "a@a.a",:firstname => "Macaque", :lastname => "Selfieur",  :password => "kaltrina", :encrypted_password => "$2a$10$kdhcUGrsb7gBk.RHrs2xK.OHMx5gdx7kmLHFozZgRdtigrlbt91Zu", :confirmation_token => "51d7292b4823498d5d8795ec30bd7e92d014d89fd0fe685ae006fa2adc08479a", :confirmation_sent_at => "2016-04-25 08:38:01.794477", :confirmed_at => "2016-04-25 08:38:01.794477",
...
# teacher
u3 = User.create(:email => "c@c.c",:firstname => "Bonobo", :lastname => "Chauve", :password => "kaltrina", :encrypted_password => "$2a$10$kdhcUGrsb7gBk.RHrs2xK.OHMx5gdx7kmLHFozZgRdtigrlbt91Zu", :confirmation_token => "51d7292b4823498d5d8795ec30bd7e92d014d89fd0fe685ae006fa2adc08479c", :confirmation_sent_at => "2016-04-25 08:38:01.794477", :confirmed_at => "2016-04-25 08:38:01.794477",
...
a1 = Advert.create(:user => u3, :topic_id => 5)
...
a2 = Advert.create(:user => u3, :topic_id => 15)
...
a3 = Advert.create(:user => u4, :topic_id => 24)
...
a4 = Advert.create(:user => u4, :topic_id => 21)
